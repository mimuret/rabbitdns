...
type MonitorCreateFunc func(string, *viper.Viper) (Monitor, error)
...
var MonitorPlugins = map[string]MonitorCreateFunc{}
var MonitorStatus = map[string]int{}

func AddMonitorPlugin(name string, newFunc MonitorCreateFunc) {
