...
type ServiceCreateFunc func(*Config, string, *viper.Viper) (Service, error)

type Service interface {
	GetEndpoints(*GetEndpointsRequest) ([]dns.RR, error)
	Path() string
}
...
var ServicePlugin = map[string]ServiceCreateFunc{}

func AddServicePlugin(name string, newFunc ServiceCreateFunc) error {
